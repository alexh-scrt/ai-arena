...
This module implements the persona
character for ParticipantAgent. It bridges the 6-agent
internal architecture with Arena's competitive environment.

Features:
- Wraps Persona character profiles
...
class Persona(LLMAgent):
    """
    Persona that wraps Persona characters.
    
    This agent represents a Persona character in the Arena,
    ...
    def __init__(
        ...
        Args:
            ...
            character_profile: Persona character profile
        """
        # Ensure correct role
